...
@Component({
  selector: 'app-nurses-sheet',
  templateUrl: './nurses-sheet.component.html',
  styleUrls: ['./nurses-sheet.component.css']
})
export class NursesSheetComponent implements OnInit {
