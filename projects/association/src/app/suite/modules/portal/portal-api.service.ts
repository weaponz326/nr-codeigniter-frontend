...
export class PortalApiService {
  ...
  public getRinks(): Observable<any>{
    return this.http.get(this.associationUrl + "module-portal/rink-list?user=" + sessionStorage.getItem('association_id'));
  }
  ...
  public getSearch(input: string, filter: string): Observable<any>{
    ...
    return this.http.get(this.associationUrl + "module-portal/search?search=" + input);
  }

  // get search detail of selected user
  public getDetail(user: string): Observable<any>{
    return this.http.get(this.associationUrl + "module-portal/search-detail/" + user);
  }

  // get source for rink types window

  public getStaff(): Observable<any>{
    return this.http.get(this.associationUrl + "module-portal/staff-list?user=" + sessionStorage.getItem('association_id'));
  }

  public getCustomers(): Observable<any>{
    return this.http.get(this.associationUrl + "module-portal/customer-list?user=" + sessionStorage.getItem('association_id'));
  }

  public getMenus(): Observable<any>{
    return this.http.get(this.associationUrl + "module-portal/menu-list?user=" + sessionStorage.getItem('association_id'));
  }
  ...
  public getSingleStaff(staffId): Observable<any>{
    return this.http.get(this.associationUrl + "module-portal/staff/" + staffId);
  }

  public getSingleCustomer(customerId): Observable<any>{
    return this.http.get(this.associationUrl + "module-portal/customer/" + customerId);
  }

  public getSingleMenu(menuId): Observable<any>{
    return this.http.get(this.associationUrl + "module-portal/menu/" + menuId);
  }
